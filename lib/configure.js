...
module.exports = function() {
  ...
  .then(function(blob) {
    ...
    return promptly.prompt('Repository remote: ', { default: 'origin' }).then(function(remote) {
      command = '[ "${TRAVIS_PULL_REQUEST}" = "false" ] && [ "${TRAVIS_BRANCH}" = "master" ] && gulp deploy --remote ' + remote;
