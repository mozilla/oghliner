...
module.exports = function(config) {
  return new Promise(function(resolve, reject) {
    ...
    console.log('Deploying "' + commitMessage + '" to GitHub Pages…');
    ...
    fs.stat(path.join(rootDir, 'node_modules'), function(err, stat) {
      ...
      gitconfiglocal('./', function(error, config) {
        ...
        ghPagesConfig.logger = ('GH_TOKEN' in process.env) ? function() {} : function(message) {
          console.log(chalk.bold.green('✓ ') + message + '… done!');
        };
