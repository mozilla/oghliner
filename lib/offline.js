      ...
      imports.forEach(function (filepath) {
        try {
          ...
          process.stdout.write(chalk.yellow.bold(
            '⚠ ' + filepath + ' doesn\'t exist or is a directory, but you\'ve added it to importScripts.\n' +
            '  To fix this problem, ensure file/path is a file or remove it from importScripts.\n'
          ));
        }
      });
    }
