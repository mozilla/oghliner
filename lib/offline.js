  ...
  return new Promise(function(resolve, reject) {
    ...
    function getFilesAndHashes(files, rootDir, sizeWhiteList) {
      ...
      var filesAndHashes = files.map(function (filepath) {
        ...
        process.stdout.write(chalk.bold.green('✓ ') + 'Caching ' + filepath + ' (' + prettyBytes(size) + ')\n');
        return {
      ...
      process.stdout.write('Total cache size is ' + prettyBytes(totalSize) + ' for ' + files.length + ' files.\n');
