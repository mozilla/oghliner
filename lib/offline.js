...
module.exports = function(config) {
  return new Promise(function(resolve, reject) {
    ...
    ghslug('./').catch(function() {
      ...
      var importsAndHashes = getImportsAndHashes(importScripts, rootDir);
    ...
    function getImportsAndHashes(imports, rootDir) {
      return imports
        .map(function (filepath) {
          ...
          return {
            path: filepath.replace(rootDir, function (match, offset) {
              //TODO: Are we sure about this replacement is not relative to the worker directory
              return offset === 0 ? '' : match;
            }),
            hash: hash,
          };
    ...
    function getVersion(filesAndHashes) {
      return getHashOfHashes(filesAndHashes.map(function(entry) {
        return entry.hash;
      }));
    }
